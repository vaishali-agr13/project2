...
<section class="py-16 bg-gray-50">
  <div class="max-w-5xl mx-auto px-4">
    ...
    <div class="text-center mb-12">
      <h2 class="text-4xl font-bold text-purple-700 mb-4">Privacy Policy</h2>
    ...
    <div class="space-y-8">
      ...
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">1. Information We Collect</h3>
      ...
      <!-- 2 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">2. How We Use Your Information</h3>
      ...
      <!-- 3 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">3. Data Protection</h3>
        <p class="text-gray-600">
      ...
      <!-- 4 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">4. Sharing of Information</h3>
        <p class="text-gray-600">
      ...
      <!-- 5 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">5. Cookies & Tracking</h3>
        <p class="text-gray-600">
      ...
      <!-- 6 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">6. Your Rights</h3>
        <p class="text-gray-600">
      ...
      <!-- 7 -->
      <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
        <h3 class="text-xl font-semibold text-purple-700 mb-3">7. Changes to Policy</h3>
        <p class="text-gray-600">
