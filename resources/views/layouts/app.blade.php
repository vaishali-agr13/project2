  ...
  <nav class="flex items-center justify-between" style="color:black;">
    ...
    <div x-show="open" 
        ...
        <div class="py-1">
            ...
            @else
                <a href="/admin/login" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                            <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
                            </svg>
                            Login
                ...
                <a href="/register" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                    <svg class="mr-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="md:hidden" x-data="{ openMenu: false }">
        ...
        <div x-show="openMenu" @click.away="openMenu = false"
            ...
            @else
                <a href="/admin/login" class="block px-4 py-2 hover:bg-gray-100">Login</a>
                <a href="/register" class="block px-4 py-2 hover:bg-gray-100">Sign Up</a>
            @endif
        </div>
    </div>
